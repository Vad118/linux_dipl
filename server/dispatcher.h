...
enum{STR_SIZE=256,COMMAND_SIZE=3,ARBITER_ID_SIZE=10,TOTAL_CLIENTS=100,TOTAL_ARBITERS=400,ARBITERS_MAX=100,MY_PORT=7500,MONITORING_PORT=7300};
...
public:
    ...
    dispatcher_answer addWorker(int worker_id, int clientSocket);
    void clearArbiters();
