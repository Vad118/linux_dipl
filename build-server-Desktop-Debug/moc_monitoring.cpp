...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Monitoring_t, stringdata) + ofs \
...
const QMetaObject Monitoring::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Monitoring.data,
      qt_meta_data_Monitoring,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Monitoring.stringdata))
        return static_cast<void*>(const_cast< Monitoring*>(this));
